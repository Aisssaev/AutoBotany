package net.neolab.botanicalextramachinery.blocks.containers.mechanicalDaisy;
...
public class ContainerDaisyBase extends BlockEntityMenu<BlockEntityDaisyBase> {
    private static final int SIZE_INVENTORY = 8;

    public ContainerDaisyBase(MenuType<? extends BlockEntityMenu<?>> type, int windowId, Level level, BlockPos pos, Inventory playerContainer, Player player) {
