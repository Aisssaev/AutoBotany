...
import net.neolab.botanicalextramachinery.gui.EnergyBar;
import net.neolab.botanicalextramachinery.gui.GreenhouseSlotInfo;
import net.neolab.botanicalextramachinery.gui.ManaBar;
...
public abstract class IndustrialScreenBase<X extends BlockEntityMenu<?>> extends AbstractContainerScreen<X> {
    ...
    public IndustrialScreenBase(X menu, Inventory inventory, Component title, int x, int y) {
        ...
        if (blockEntity instanceof ElectricBotanicalTile electricBotanicalTile) {
            ...
            this.energyBar = new EnergyBar(this, electricBotanicalTile.getMaxEU(), x, 111);
        } else {
    ...
    public void setGuiCoord(){
        ...
        this.energyBar.setGuiCoord(this.leftPos, this.topPos-9);
    }
    ...
    public void render(@Nonnull PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        if (blockEntity instanceof ElectricBotanicalTile bt) {
            ...
            this.energyBar.renderHoveredToolTip(poseStack, mouseX, mouseY, bt.getStoredEU());
        }
    }
