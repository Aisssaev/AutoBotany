package net.neolab.botanicalextramachinery.blocks.tesr.mechanicalOrechid;
...
public class RenderOrechidUpgraded implements BlockEntityRenderer<BlockEntityOrechidUpgraded> {
    public RenderOrechidUpgraded() {
    }
    ...
    @Override
    public void render(BlockEntityOrechidUpgraded blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int light, int overlay) {}
}
