...
public class RenderAlpheimMarketBase extends RotatedBlockRenderer<BlockEntityAlfheimMarketBase> {
    public RenderAlpheimMarketBase() {
    }

    public void doRender(@Nonnull BlockEntityAlfheimMarketBase tile, float partialTick, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int light, int overlay) {
        if (LibXClientConfig.RenderingVisualContent.all && LibXClientConfig.RenderingVisualContent.AlfheimMarketSettings.alfheimMarketBase) {
            poseStack.pushPose();
