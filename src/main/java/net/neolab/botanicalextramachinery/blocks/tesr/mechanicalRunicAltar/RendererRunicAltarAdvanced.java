package net.neolab.botanicalextramachinery.blocks.tesr.mechanicalRunicAltar;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.math.Vector3f;
import net.neolab.botanicalextramachinery.blocks.tiles.mechanicalRunicAltar.BlockEntityRunicAltarAdvanced;
...
public class RendererRunicAltarAdvanced extends RotatedBlockRenderer<BlockEntityRunicAltarAdvanced> {
    public RendererRunicAltarAdvanced() {
    }

    protected void doRender(@Nonnull BlockEntityRunicAltarAdvanced tile, float partialTicks, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int light, int overlay) {
        if (LibXClientConfig.RenderingVisualContent.all && LibXClientConfig.RenderingVisualContent.RunicAltarSettings.runicAltarAdvanced) {
