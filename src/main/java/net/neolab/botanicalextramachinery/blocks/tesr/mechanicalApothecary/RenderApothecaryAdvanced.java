package net.neolab.botanicalextramachinery.blocks.tesr.mechanicalApothecary;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.math.Vector3f;
import net.neolab.botanicalextramachinery.blocks.tiles.mechanicalApothecary.BlockEntityApothecaryAdvanced;
import net.neolab.botanicalextramachinery.config.LibXClientConfig.RenderingVisualContent;
...
public class RenderApothecaryAdvanced extends RotatedBlockRenderer<BlockEntityApothecaryAdvanced> {
    public RenderApothecaryAdvanced() {
    }

    protected void doRender(@Nonnull BlockEntityApothecaryAdvanced tile, float partialTick, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int light, int overlay) {
        if (RenderingVisualContent.all && RenderingVisualContent.ApothecarySettings.apothecaryAdvanced) {
            int items;
