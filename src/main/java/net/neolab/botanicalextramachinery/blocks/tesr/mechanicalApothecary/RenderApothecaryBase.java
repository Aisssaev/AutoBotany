...
import net.neolab.botanicalextramachinery.blocks.tiles.mechanicalApothecary.BlockEntityApothecaryBase;
...
public class RenderApothecaryBase extends RotatedBlockRenderer<BlockEntityApothecaryBase> {
    public RenderApothecaryBase() {
    }

    protected void doRender(@Nonnull BlockEntityApothecaryBase tile, float partialTick, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int light, int overlay) {
        if (RenderingVisualContent.all && RenderingVisualContent.ApothecarySettings.apothecaryBase) {
            int items;
