...
public class ItemShadowManaSpark extends ItemBase {


    public ItemShadowManaSpark(ModX mod, Properties properties) {
    ...
    public static boolean attachSpark(Level world, BlockPos pos, ItemStack stack) {
        ...
        if (attach != null && attach.canAttachSpark(stack) && attach.getAttachedSpark() == null) {
            if (!world.isClientSide) {
                ...
                EntityShadowManaSpark spark = new EntityShadowManaSpark(world);
