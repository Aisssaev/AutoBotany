...
public class PrimitiveGreenhouseRecipeCategory implements IRecipeCategory<PrimitiveGreenhouseRecipe> {
    public static final RecipeType<PrimitiveGreenhouseRecipe> TYPE = RecipeType.create("autobotany", "primitive_greenhouse", PrimitiveGreenhouseRecipe.class);
    ...
    public PrimitiveGreenhouseRecipeCategory(IGuiHelper helper, ResourceLocation texture, ItemLike provider) {
    ...
    public PrimitiveGreenhouseRecipeCategory(IGuiHelper helper, ItemStack stack, IDrawable background, IDrawable progress, IDrawable charge) {
        this.stack = stack;
    ...
    @Override
    public @NotNull RecipeType<PrimitiveGreenhouseRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public @NotNull Component getTitle() {
        return Component.translatable("autobotany.screen.title.primitive_greenhouse");
    }
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder layout, PrimitiveGreenhouseRecipe recipe, @NotNull IFocusGroup iFocusGroup) {
    ...
    public void draw(PrimitiveGreenhouseRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull PoseStack stack, double mouseX, double mouseY) {
