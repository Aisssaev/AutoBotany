...
public class LibNames {
    ...
    public static final String MANASTEEL_ADVANCED_ALLOY = "manasteel_advanced_alloy";
    public static final String MANASTEEL_INGOT_ADVANCED_ALLOY = "manasteel_ingot_advanced_alloy";
    public static final String ELEMENTIUM_ADVANCED_ALLOY = "elementium_advanced_alloy";
    public static final String ELEMENTIUM_INGOT_ADVANCED_ALLOY = "elementium_ingot_advanced_alloy";
    public static final String TERRASTEEL_ADVANCED_ALLOY = "terrasteel_advanced_alloy";
    public static final String TERRASTEEL_INGOT_ADVANCED_ALLOY = "terrasteel_ingot_advanced_alloy";
    public static final String GAIASTEEL_ADVANCED_ALLOY = "gaiasteel_advanced_alloy";
    public static final String GAIASTEEL_INGOT_ADVANCED_ALLOY = "gaiasteel_ingot_advanced_alloy";
